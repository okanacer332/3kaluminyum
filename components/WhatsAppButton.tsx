...
export function WhatsAppButton() {
  // Numara formatı: +90 553 878 92 39 -> 905538789239 (Boşluksuz ve + sız)
  const phoneNumber = "905538789239";
  const message = "Merhaba, bilgi almak istiyorum."; // Varsayılan mesaj (İstersen boş bırakabilirsin)
  ...
  return (
    ...
    >
      ...
      {/* Tooltip (Opsiyonel: Hover yapınca yazı çıkar) */}
